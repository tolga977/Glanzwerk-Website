...
export default function LocationCard({ district }: { district: District }) {
  return (
    ...
    >
      ...
      />
      <div>
        <div className="flex h-12 w-12 items-center justify-center rounded-control bg-gradient-to-br from-brand-50 to-brand-100 text-brand-500 transition-transform duration-300 ease-out group-hover:scale-105">
