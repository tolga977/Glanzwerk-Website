...
export default function PromoBar({ text, shortText, href }: PromoBarProps) {
  return (
    <Link
      href={href}
      className="block bg-brand-900 py-2 text-center text-xs font-medium text-brand-100 transition-colors duration-300 ease-out hover:bg-brand-800 sm:text-sm"
    >
